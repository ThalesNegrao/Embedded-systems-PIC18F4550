...
//   Alteração 2: Thales Maia Mendonça Negrão : adequação ao projeto
// -----------------------------------------------------------------------
...
#define SPPEPS  (*(volatile __near unsigned char*)0xF64)
#define SPPDATA  (*(volatile __near unsigned char*)0xF62)

#define SSPSTAT  (*(volatile __near unsigned char*)0xFC7)
#define SSPADD  (*(volatile __near unsigned char*)0xFC8)
